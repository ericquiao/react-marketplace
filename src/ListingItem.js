...
const Button = (props) => {
  ...
  return(
          <button type="button" className="inline-flex justify-center items-center py-2 px-4 border shadow-sm text-sm font-medium rounded-md text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
...
const EditBtn = (props) => {
  return  <Button className="border-transparent"
            onClick = { () => alert('Edit btn clicked, edit item.')} title="Edit"
          >
...
const DelBtn = (props) => {
  return <Button className="border-pink-500"
            onClick = { () => alert('Delete btn clicked, delete the item.')} title="Delete"
         >
        ...
        <div className=" flex-1 flex md:flex-col justify-between items-start md:items-stretch gap-3 px-2">
          <div className="mt-1 flex-1">
            <div className="flex justify-between items-center gap-3">
              ...
              <div className="text-sm text-gray-500">{props.availability}</div>
              </div>

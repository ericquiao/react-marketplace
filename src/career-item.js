...
const DeleteButton = () => {
  return(
    <Button onClick = { () => alert('Delete btn clicked. Delete the item.')} 
      title="Delete">
                      ...
                      <div className="mt-2 flex">
                        <div className=" flex items-center gap-2 text-sm leading-5 text-gray-500">
                          <WorkingBagIcon />
                            ...
                            {props.studentFriendly && ( <span className=" inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                            Student-friendly
                          </span>)}
                        </div>
                      </div>

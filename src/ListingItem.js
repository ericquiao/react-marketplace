export const ListingItem = () => {
    return (
        ...
        <div className=" group block w-full rounded-lg bg-gray-100 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 focus-within:ring-pink-500 overflow-hidden">
          <img src="https://images.unsplash.com/photo-1594995846645-d58328c3ffa4?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=543&amp;h=384&amp;q=80" alt="" className="
              object-cover pointer-events-none group-hover:opacity-75 h-48 w-full"/>
        ...
        <div className=" flex-1 flex md:flex-col justify-between items-start md:items-stretch gap-3 px-2">
          ...
          <div className="flex flex-col md:flex-row gap-3 py-3">
            <button type="button" className="
                ...
                focus:ring-offset-2
                focus:ring-pink-500"
                onClick = { () => alert('Edit btn clicked, edit item.')}
            >
